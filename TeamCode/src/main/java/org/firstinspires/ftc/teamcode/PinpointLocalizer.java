...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1072.5246029825166; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 793.7882725721058; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        // TODO: reverse encoder directions if neededF
